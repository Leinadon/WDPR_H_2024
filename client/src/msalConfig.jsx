...
export const msalConfig = {
    auth: {
        ...
        redirectUri: 'https://accessibilityh.azurewebsites.net/menupagina', // Points to window.location.origin. You must register this URI on Azure Portal/App Registration.
